...
namespace Calculator {
	...
	static bool prom_enable{ false };		// Вывод приглашения к вводу по умолчанию
	static bool result_enable{ false };		// Вывод обозначения вывода по умолчанию
	static bool no_loop{ true };			// Зацикленный режим работы функции calculate
	...
	extern bool calculate();						// Логика работы калькулятора
